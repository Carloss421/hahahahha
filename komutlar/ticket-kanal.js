...
message.channel.send(new Discord.MessageEmbed().setColor('GOLD').setDescription(`Mesajın kanalı başarıyla ayarlandı: ${prefix}ticket gönder`))
}
...
message.channel.send(new Discord.MessageEmbed().setColor('GOLD').setDescription(`Mesajın kanalı başarıyla sıfırlandı: ${prefix}ticket-kanal ayarla #channel`))
}
};
exports.conf = {
  enabled: true,
