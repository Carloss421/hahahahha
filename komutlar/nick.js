...
if(!message.member.roles.has("697349767096696844")) return message.channel.send(`**bu komutu kullanabilmek için Gerekli Yetkiye sahip olmasınız.**`);
...
.setColor('RANDOM')
message.react('699528754543722566')
