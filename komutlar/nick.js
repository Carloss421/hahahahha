...
if(!message.member.roles.has("704273133426704404")) return message.channel.send(`**bu komutu kullanabilmek için Gerekli Yetkiye sahip olmasınız.**`);
...
.setColor('RANDOM')
message.react('704619926324903987') //emoji id
