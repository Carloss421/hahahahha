...
\`1 aylık premium'da\` **bot'un istatistiklerinde premium kullanıcı (1 aylık) olarak isminiz yazılır ve eğlence,kullanıcı menülerindeki premium komutlarını kullanabilirsiniz ve sunucumuzda \`PREMIUM KULLANICI\` rolünü alabilirsiniz.**
...
\`5 aylık premium'da\` **bot'un istatistiklerinde premium kullanıcı (5 aylık) olarak isminiz yazılır ve eğlence,kullanıcı,moderasyon menülerindeki premium komutlarını kullanabilirsiniz ve sunucumuzda \`PREMIUM KULLANICI\` rolünü alabilirsiniz.**

\`10 aylık premium'da\` **bot'un istatistiklerinde premium kullanıcı (10 aylık) olarak isminiz yazılır, sunucunuza özel komutlar ve eğlence,kullanıcı,moderasyon menülerindeki premium komutlarını kullanabilirsiniz ve sunucumuzda \`PREMIUM KULLANICI\` rolünü alabilirsiniz.**
