...
exports.run = async (client, msg, args) => {
  ...
  ctx.fill()
    ...
    //ctx.drawImage(avatar, 85, 66, 150, 150);
       ...
       if (msg.channel.send(`<@${msg.author.id}>, Seviye sistemi açık değil. Yetkililerden açmasını iste. `).then(message => message.delete(5000))) {
        msg.delete()
      } else return;
    ...
    } else  if (msg.channel.send(`<@${msg.author.id}>, kendi seviye sistemini açman gerek.`).then(message => message.delete(5000))){
	 msg.delete()
	} else return;
