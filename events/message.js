...
var lang = tr;
  ...
  if (cmd) {
if(!lg){
if(message.content.startsWith("!dil-ayarla")) (client, message, args) => {
let dilSeç = args[1]
...
if(message.content.startsWith("!set-language")) (client, message, args) => {
let dilSeç = args[1]
...
if(message.content.startsWith("!language-set")) (client, message, args) => {
