...
module.exports = (client) => {
  ...
  const bilgiler = {
    oauthSecret: "x3G6zCZ4OCzACr18fmA8CT3SKBBhosYg",
    callbackURL: `https://alvibotaltyapi.glitch.me/callback`,
    domain: `https://alvibotaltyapi.glitch.me`
  };
...
res.redirect("/panel/"+req.params.guildID+"/genel");
  ...
  app.get("/ekle", (req, res) => {
   ...
   app.get("/seviye", (req, res) => {
    res.redirect(`https://dash.alvibot.org/kullanici/${req.params.kullaniciID}/yonet`);
  });
